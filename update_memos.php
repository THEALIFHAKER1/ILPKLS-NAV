...
while($taginfo = mysqli_fetch_array($tagdata)){ ?>
	<option value="<?php echo $taginfo["COLOR"]; ?>"><?php echo $taginfo["TAG"]; ?></option>
<?php }
 ?>  
      </select> 
                </div>
				...
				<input name="CONTENT" type="text" required class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600" value="<?php echo $CONTENT;?>"></div>
                <div class="mt-4">
