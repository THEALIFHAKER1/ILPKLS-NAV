...
<div class="relative center text-white"> 
    <img class="object-cover w-full h-[500px] rounded-[52px] p-7" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($info1["IMG"]); ?>" />
</div>
<?php
...
<?php } ?>
    ...
    <div class="h-screen w-full flex-[50%]">
        <div>
            ...
            <div style=""><iframe class="h-[500px] p-7 rounded-[52px] w-full"  src="<?php echo $info1["LINK"] ?>"style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
        </div>
        <div>
        <?php
  $data = mysqli_query($con, "SELECT * FROM people WHERE LOCATION='$NAMAPLACE'");
  $rowcount=mysqli_num_rows($data);
  ?>
...
<div class="flow-root">
    ...
    <?php $data = mysqli_query($con,"SELECT * FROM people WHERE LOCATION='$NAMAPLACE'");
while ($info = mysqli_fetch_array($data)) { ?>
        <li class="py-3 sm:py-4">
            <div class="flex items-center space-x-4">
                <div class="flex-shrink-0">
                    <img class="w-10 h-10 rounded-full" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($info["IMG"]); ?>" alt="">
                </div>
                <div class="flex-1">
                    ...
                    <?php echo $info["EMAIL"]; ?>
                        ...
                        <a href="<?php echo $info["TELE"]; ?>"><img class="h-4 w-4" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Telegram_logo.svg/2048px-Telegram_logo.svg.png" alt=""></a>
                </div>
